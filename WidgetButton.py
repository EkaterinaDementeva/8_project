...
class WidgetButton(QtWidgets.QWidget):
    ...
    When we click - our cursor carries MimeData that we need
    to feed with some custom info
    """
    ...
    def mousePressEvent(self, event):
        ...
        mimeData = MyMIME()
        # create mimeData class|nothing too much happes here
        ...
        # create Drag class to copy information between applications
        drag.setMimeData(mimeData)
        # data to be sent with Drag
